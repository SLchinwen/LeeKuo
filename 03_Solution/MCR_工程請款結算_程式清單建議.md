...
| **MCR320** | 客戶設備對應工作項目建檔 | **整批匯入** | **廠區 + 設備編號**（維修廠區設備清單，選單一設備）後匯入該設備的標準工作項目；**不對應合約**。欄位：設備編號、設備名稱、項次、工作項目名稱、數量、**加成**（預設加成比例）；匯入或載入查詢時可呈現**對應不到最新合約工作項目單價**的筆數提示，清單中無法對應的該筆以**紅色**顯示；建檔時即有預設加成，後續可於 MCR340 加成作業開放調整 |
